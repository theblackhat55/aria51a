-- ARIA5.1 Enterprise Security Intelligence Platform - Comprehensive Seed Data (Fixed)
...
-- Clear existing data in correct order (children first, parents last)
...
-- Risk Control Mappings (8 key mappings)
...
(3, 2, 'ID.AM-1', 70, 0.80, 'Asset identification helps track third-party dependencies that pose supply chain risks', '2024-12-02 11:15:00', '2024-12-14 16:25:00'),
(4, 3, 'CC6.2', 95, 0.94, 'Privileged access management directly addresses insider threat risks', '2024-12-03 09:30:00', '2024-12-13 12:45:00'),
(5, 4, 'PR.AC-1', 80, 0.86, 'Access control management includes API rate limiting and authentication controls', '2024-12-04 14:20:00', '2024-12-12 10:15:00'),
(6, 5, 'Article 25', 90, 0.91, 'Data protection by design directly addresses GDPR compliance gaps', '2024-12-05 13:40:00', '2024-12-11 15:10:00'),
(7, 6, 'CC6.1', 70, 0.82, 'MFA provides additional protection against phishing credential compromise', '2024-12-06 12:10:00', '2024-12-10 09:30:00'),
(8, 8, 'PR.AC-1', 88, 0.90, 'Identity and access management controls directly mitigate SSO integration risks', '2024-12-08 15:25:00', '2024-12-09 11:40:00');

-- RAG Documents (5 knowledge base documents)
...
-- Generate some recent audit logs
