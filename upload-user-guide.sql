-- Upload Platform User Guide to RAG System
-- This script uploads the comprehensive user documentation for platform usage

INSERT INTO rag_documents (
  title, content, document_type, metadata, embedding_status, 
  organization_id, uploaded_by, created_at, updated_at
) VALUES (
  'ARIA5.1 Platform - Comprehensive User Guide (USR-001)',
...
- Updated automatically with platform changes',
  'guidance',
  '{"document_type": "user_guide", "version": "1.0", "classification": "Internal", "owner": "Platform Development Team", "covers": ["risk_management", "compliance", "operations", "ai_assistant", "policy_management"], "word_count": 28063}',
  'pending',
  1,
  1,
  CURRENT_TIMESTAMP,
